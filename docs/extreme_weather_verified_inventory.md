...
- `data/raw/extreme_weather_verified/verified_extreme_weather_inventory_2015_2025.csv`
...
- point back to the original hazard-specific raw file when a row was carried forward from an existing verified source
